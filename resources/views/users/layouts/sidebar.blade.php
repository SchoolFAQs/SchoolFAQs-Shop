      ...
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
         <li class="nav-item sidebar-heading text-muted"> 
               <h6><i class="fa fa-user"></i> SchoolFAQs</h6>
          </li>
                ...
                <div data-role="main" class="ui-content">
                  ...
                  <h3>Categories</h3>
                    ...
                    <div class="form-group form-check">
                      <input type="checkbox" value="{{$cat->id}}" class="form-check-input" id="exampleCheck1">
                      <label class="form-check-label" for="exampleCheck1">{{$cat->category_name}}</label>
                    </div>
                    @endforeach
                    @csrf
                      <input type="submit" class="btn btn-primary" value="Search" data-inline="true" value="Submit">
                    </form>
                </div>
              </div>
          </li>
