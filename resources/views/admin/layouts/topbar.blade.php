<header class="sticky-top">
	<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  		<a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"><i class="fas fa-shopping-cart"></i> SchoolFAQs Store</a>
        ...
        <span class="navbar-toggler-icon"></span>
          ...
          <form  action="{{ route('logout') }}" method="POST">
            <input type="submit" class="btn form-control btn-danger" value="Sign Out">
              @csrf
          </form>
